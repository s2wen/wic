...
function ReviewContent({user}: {user: User}) {
    ...
    async function handlePublish() {
        ...
        await createStudyGroup({
            ...
            time: `${fmt12(timeFrom)} – ${fmt12(timeTo)}`,
            date: day ? new Date(day) : null,
            spots: preference === "biggroups" ? 10 : preference === "1on1" ? 2 : 6,
            color: "teal",
        })
                ...
                <div className={styles.reviewCard}>
                    ...
                    <div className={styles.reviewFooter}>
                        ...
                        <div className={styles.footerActions}>
                            ...
                            <button className={styles.publishButton} onClick={handlePublish}>Publish group</button>
                        </div>
                    </div>
                </div>
...
export default function ReviewPage({user} : {user: User}) {
    return (
        <Suspense>
